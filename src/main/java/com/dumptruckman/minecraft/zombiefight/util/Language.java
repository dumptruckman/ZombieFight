...
public class Language {
    ...
    public static final Message CMD_BORDER_HELP = new Message("cmd.border.help",
            "Checks or sets a world's game border size.",
            "The border will be square and extend out from the spawn point for the world by the specified number of blocks.",
            "Example: ",
            "  /zf border 150",
            "  /zf border");
    ...
    public static final Message CMD_GSPAWN_HELP = new Message("cmd.gspawn.help",
            "Warps you to the game spawn or sets one.",
            "Flags:",
            "  -s sets the spawn to your current location.");
    ...
    public static final Message CMD_START_GAME_HELP = new Message("cmd.start.help",
            "Starts the game for the world you are in or the specified world.",
            "Flags:",
            "  -w Specify a certain world to start the game in.",
            "  -f Forces the game to start immediately, skipping the normal start countdown.");
    ...
    public static final Message CMD_END_GAME_HELP = new Message("cmd.end.help",
            "Ends the game for the world you are in or the specified world.",
            "Flags:",
            "  -w Specify a certain world to end the game in.",
            "  -f Forces the game to end immediately, skipping the normal end duration.");
    ...
    public static final Message CMD_ENABLE_HELP = new Message("cmd.enable.help",
            "Enables the game for the world you are in.",
            "Flags:",
            "  -w Use this to specify a different world: /zf enable -w world_nether");
    ...
    public static final Message CMD_SELECT_HELP = new Message("cmd.select.help",
    ...
    public static final Message CMD_DESELECT_HELP = new Message("cmd.deselect.help",
    ...
    public static final Message CMD_CLEANUP_HELP = new Message("cmd.cleanup.help",
            "Allows user to clean up during a game.",
            "This causes blocks they place/destroy to not be reset at the end of the game.");
    ...
    public static final Message CMD_KIT_HELP = new Message("cmd.kit.help",
            "Lists kits available to you or selects a kit for the next game.",
            "Examples:",
            "  /kit",
            "  /zf kit",
            "  /kit some awesome kit");
    ...
    public static final Message CMD_DISABLE_HELP = new Message("cmd.disable.help",
            "Disables the game for the world you are in.",
            "Flags:",
            "  -w Use this to specify a different world: /zf disable -w world_nether");

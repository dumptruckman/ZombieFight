...
import com.dumptruckman.minecraft.zombiefight.api.CRChest.Constants;
...
public interface ZFConfig extends BaseConfig {
    ...
    ListConfigEntry<String> RESET_WORLDS = new EntryBuilder<String>(String.class, "settings.restock_chests_reset_worlds")
            ...
            .comment("# These are worlds that all ZombieFight chests will be restocked in when Multiverse-Adventure resets the worlds.")
